...
exports.FieldWrapper = function (WrappedComponent) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.render = function () {
            ...
            return (react_1.default.createElement("div", { className: classnames_1.default("form-group", "col" + (size ? "-" + size : "")) },
                react_1.default.createElement("div", { className: "row" },
                    ...
                    react_1.default.createElement(WrappedComponent, __assign({}, this.props, { className: classnames_1.default("form-control", {
                        ...
                        }, { disabled: disabled }, { "d-none": visible === false }), id: input.name }))),
                react_1.default.createElement("div", { className: "invalid-feedback" }, meta.error)));
        };
        return class_1;
