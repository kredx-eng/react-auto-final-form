        ...
        _this.getFields = function (parsedSchema, arrayProperties) {
            if (Array.isArray(parsedSchema)) {
                return parsedSchema.map(function (layout) {
                    return (react_1.default.createElement("div", { className: classnames_1.default(layout.orientation === "vertical" ? "col" : "row") }, Object.keys(layout.fields).map(function (fieldName) {
                        // @ts-ignore
                ...
                return (react_1.default.createElement("div", { className: orientation_1 === "vertical" ? "verticalLayout" : "horizontalLayout" }, Object.keys(modfifiedArraySchema_1).map(function (fieldName) {
