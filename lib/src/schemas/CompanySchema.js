            ...
            fields: [
                ...
                },
                {
                    ...
                    visible: function (m, r, g) {
                        var org_type_accepted = m.type != "FOREIGN_COMPANY";
                    ...
                    error: function (model, f, global) {
                        ...
                        if (pan_number) {
                            ...
                            var PAN_ERROR = "Invalid PAN number. Valid format is ABCDE1234F";
                            var PAN_INVALID_ERROR = "Invalid PAN number.";
                            if (!pan_number) {
                ...
                },
                {
                    ...
                    type: "string",
                    visible: function (m, r, g) {
                        var org_type_accepted = m.type == "PRIVATE_LIMITED" ||
                ...
                },
                {
                    ...
                    type: "string",
                    visible: function (m, r, g) {
                        var org_type_accepted = m.type == "LIMITED_LIABILITY";
                        return org_type_accepted;
                    },
                    error: function (m, r, g) {
                        var org_type_accepted = m.type == "LIMITED_LIABILITY";
