        ...
        _this.render = function () {
            ...
            return (react_1.default.createElement("div", { className: "container-fluid form-builder" },
                react_1.default.createElement(react_final_form_2.Form, __assign({}, formProps, { mutators: __assign({}, final_form_arrays_1.default, { date: dateMutator }), render: function (formProps) {
                        ...
                        return (react_1.default.createElement("form", { onSubmit: formProps.handleSubmit, className: "form-horizontal" },
                            _this.getFields(parsedSchema),
                            react_1.default.createElement(react_final_form_2.Field, { name: "bottomBar", component: _this.props.bottomBar, key: "bottomBar", onSubmit: formProps.handleSubmit })));
                    } }))));
        };
