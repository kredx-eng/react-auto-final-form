...
var SchemaEvaluator = /** @class */ (function () {
    ...
    function SchemaEvaluator(schema, initialEntityName, layoutName) {
        ...
        this.parseEntity = function (entityName, layoutName, isInitialEntity) {
            ...
            if (!requiredEntity) {
                ...
                if (layoutName && requiredEntity.layouts) {
                    _this.getLayoutFields(requiredEntity, layoutName, false, isInitialEntity);
                }
        ...
        this.getLayoutFields = function (entity, layoutName, isArrayField, isInitialEntity) {
            ...
            if (!requiredLayout) {
                ...
                if (requiredLayout.groups) {
                    requiredLayout.groups.forEach(function (group) {
                        _this.generateLayoutFields(group, entity, isArrayField, isInitialEntity);
                    });
                }
                else {
                    _this.generateLayoutFields(requiredLayout, entity, isArrayField, isInitialEntity);
                }
            }
        };
        this.generateLayoutFields = function (layout, entity, isArrayField, isInitialEntity) {
            var mergedFields = [];
            // @ts-ignore
            ...
            _this.getFields(customEntity, true, isInitialEntity, isArrayField);
