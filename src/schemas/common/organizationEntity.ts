 ...
 */
const organizationDetailPreSanctionEntity = {
...
const organizationDetailPostSanctionEntity = {
  // Entity for vendor organization detail(Tab 1)
  name: "organization_info",
  fields: [
    {
...
export {
  ...
  organizationDetailPostSanctionEntity
};
