...
var ArrayContainer_1 = require("../components/ArrayContainer");
        ...
        _this.renderField = function (field, fieldName, arrayProperties) {
            ...
            if (FormHelper_1.FormHelper.fieldPropertyCheck(field)) {
                ...
                return (react_1.default.createElement("div", { className: "m-20", key: fieldName },
                    ...
                    react_1.default.createElement(react_final_form_arrays_1.FieldArray, { name: fieldName, render: function (fieldArrayProps) { return (react_1.default.createElement(ArrayContainer_1.ArrayContainer, { addField: _this.formProps.form.mutators.push, name: fieldName, deleteField: _this.formProps.form.mutators.pop, arrayProps: fieldArrayProps }, fieldArrayProps.fields.map(function (name) {
