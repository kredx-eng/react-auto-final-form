            ...
            if (Array.isArray(parsedSchema)) {
                return parsedSchema.map(function (layout) {
                    return (react_1.default.createElement("div", { 
                        ...
                        // }
                        className: layout.orientation === "vertical" ? "col" : "form-row" }, Object.keys(layout.fields).map(function (fieldName) {
                        // @ts-ignore
                ...
                return (react_1.default.createElement("div", { 
                    ...
                    //     : styles.horizontalLayout
                    // }
                    className: orientation_1 === "vertical" ? "col" : "form-row" }, Object.keys(modfifiedArraySchema_1).map(function (fieldName) {
