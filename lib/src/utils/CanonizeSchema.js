...
exports.canonizeSchema = function (schema) {
    ...
    if (!schema.entities) {
        ...
        Object.keys(schema.entities).forEach(function (entityName) {
            ...
            canonizedSchema.entities.push(Object.assign({}, __assign(__assign({}, canonizedEntity), { name: entityName })));
        });
    ...
    if (entity.fields) {
        if (Array.isArray(entity.fields)) {
            ...
            Object.keys(entity.fields).forEach(function (fieldName) {
                canonizedEntity.fields.push(Object.assign({}, __assign(__assign({}, entity.fields[fieldName]), { name: fieldName })));
            });
