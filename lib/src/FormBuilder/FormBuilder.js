...
var FormBuilderStyles_1 = __importDefault(require("./FormBuilderStyles"));
...
var FormBuilder = /** @class */ (function (_super) {
    ...
    function FormBuilder() {
        ...
        _this.render = function () {
            ...
            return (react_1.default.createElement("div", { className: "container-fluid form-builder" },
                react_1.default.createElement(react_final_form_2.Form, __assign({}, formProps, { mutators: __assign(__assign({}, final_form_arrays_1.default), { date: dateMutator }), render: function (formProps) {
                        ...
                        return (react_1.default.createElement("form", { onSubmit: formProps.handleSubmit },
                            ...
                            react_1.default.createElement(react_final_form_2.Field, { name: "bottomBar", component: _this.props.bottomBar, key: "bottomBar" })));
                    } }))));
        };
        _this.getFields = function (parsedSchema, arrayProperties) {
            if (Array.isArray(parsedSchema)) {
                return parsedSchema.map(function (layout) {
                    return (react_1.default.createElement("div", { className: classnames_1.default(layout.orientation === "vertical"
                            ? "verticalLayout"
                            : "horizontalLayout"), 
                        // @ts-ignore
                        style: layout.orientation === "vertical"
                            ? FormBuilderStyles_1.default.verticalLayout
                            : FormBuilderStyles_1.default.horizontalLayout }, Object.keys(layout.fields).map(function (fieldName) {
                        // @ts-ignore
                ...
                return (react_1.default.createElement("div", { className: orientation_1 === "vertical" ? "verticalLayout" : "horizontalLayout", 
                    // @ts-ignore
                    style: orientation_1 === "vertical"
                        ? FormBuilderStyles_1.default.verticalLayout
                        : FormBuilderStyles_1.default.horizontalLayout }, Object.keys(modfifiedArraySchema_1).map(function (fieldName) {
